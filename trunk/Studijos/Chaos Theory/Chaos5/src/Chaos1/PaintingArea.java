...
public class PaintingArea extends java.awt.Canvas{
   ...
   public javax.swing.JPanel panel = null;
   ...
   public void iterate(Poly input, int depth, Color clr)
   {
       if (depth < max)
       {
           ...
           {
               if (transformations.get(i).koef > 0)
               {
                 Poly tr = transformations.get(i).Transform(input, depth);
                 //iterate(tr, depth + 1, (i == 0)?Color.RED:((i == 1)?Color.BLUE:Color.BLACK));
       ...
       {
           input.PaintPoly(innerG, length, clr);
       }
   }
   ...
   {
       stdPoly = new Poly();
       //stdPoly.Add(new Pixel(0.5, 0.5));
       //stdPoly.Add(new Pixel(0.5, -0.5));
       //stdPoly.Add(new Pixel(-0.5, -0.5));
       //stdPoly.Add(new Pixel(-0.5, 0.5));
       stdPoly.Add(new Pixel(-0.5, 0.5));
       stdPoly.Add(new Pixel(-0.5, -0.5));
       stdPoly.Add(new Pixel(-0.5, 0));

       
   }

   public void initTransformations(int koef)
   {
       ...
       transformations.add(new Transformation(tr1, 0, 0.5));
       transformations.add(new Transformation(tr2, 0.5, 0.5));
       transformations.add(new Transformation(tr3, 0, 0));
       transformations.add(new Transformation(tr4, 0.5, 0));
   }
