...
<ul id="menu">
   ...
   <li class="selected">
    ...
    <%= Html.LineChart<ProjectIntensivity>(legends, ViewData.Model, "Period", yAxes, colors, System.Drawing.Color.White, "Projekto intensyvumas", "Laikotarpis", "Val.", (ViewData.Model.Count > 5) ? ViewData.Model.Count * 50 + 160 : 600, 400)%>
