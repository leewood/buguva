...
public class ChaosMainView extends FrameView {
    ...
    public ChaosMainView(SingleFrameApplication app) {
        ...
        initComponents();
        MainPanel va	= new MainPanel();
        String[] args = new String[1];
        args[0]="";
        java.awt.Frame frame	= new jv.object.PsMainFrame(va, "Maldebrotas ir Julia", args);
		va.m_frame = frame;
		va.init();
		...
		frame.pack();
		va.start();
		frame.setBounds(new java.awt.Rectangle(420, 5, 640, 680));
		frame.setVisible(true);
        this.mainPanel.add(frame);
    ...
    private void initComponents() {
        ...
        mainPanelLayout.setVerticalGroup(
            mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(paintingArea1, javax.swing.GroupLayout.DEFAULT_SIZE, 323, Short.MAX_VALUE)
        );
